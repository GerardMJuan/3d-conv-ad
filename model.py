...
def c3d():
    ...
    This function tries to modify the existing by 1) reducing it to 1 channel and,
    2) actually changing the input to larger images.
    """
    # Load c3d base model
    c3d_model = c3d_base()
...
def c3d_base(weights=False, summary=True, mean=False, weights_file=None, mean_file=None):
    """
